...
struct sfptpd_servo {
	...
	struct timespec clock1_snapshot;
	struct timespec clock2_snapshot;
...
static int do_servo_synchronize(struct sfptpd_engine *engine, struct sfptpd_servo *servo, struct timespec *mono_time)
{
